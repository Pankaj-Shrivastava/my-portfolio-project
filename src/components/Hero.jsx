  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-10 md:py-20">
      ...
      <div className="order-first lg:order-last">
        <div className="w-full aspect-square md:aspect-[4/3] bg-slate-100 rounded-3xl flex items-center justify-center border border-slate-200 shadow-sm relative overflow-hidden">
